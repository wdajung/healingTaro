...
<!-- 로그인 시작 { -->
<div id="mb_login" class="mbskin" style="font-family: 'NanumSquareRound',sans-serif;">
    ...
    <fieldset id="login_fs">
        ...
        <input type="text" name="mb_id" id="login_id" required class="frm_input required" size="20" maxLength="20" placeholder="ID" style="height:2.5em; width:79%; font-size:1.3em; padding-left:10px;">
        <label for="login_pw" class="login_pw">비밀번호<strong class="sound_only"> 필수</strong></label>
        <input type="password" name="mb_password" id="login_pw" required class="frm_input required" size="20" maxLength="20" placeholder="PW" style="height:2.5em; width:79%; font-size:1.3em; padding-left:10px;">
        <input type="submit" value="로그인" class="btn_submit"><br>
        <div style="float:right;">
			<input type="checkbox" name="auto_login" id="login_auto_login">
			<label for="login_auto_login" style="font-size:1.3em;">자동로그인</label>
		</div>
    </fieldset>
    ...
    <aside id="login_info">
        <h2 style="font-size:1.3em;">회원로그인 안내</h2>
