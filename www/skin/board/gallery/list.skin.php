...
<p style="text-align:center; font-size:3em; padding:40px 0 50px 0; font-family: 'NanumSquareRound',sans-serif;"><?php echo $board['bo_subject'] ?></p>


<!-- 게시판 목록 시작 { -->
<div id="bo_gall" style="width:<?php echo $width; ?>; font-family: 'NanumSquareRound',sans-serif; font-size:1.2em;">
