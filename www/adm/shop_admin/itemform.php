...
<section id="anc_sitfrm_extra">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
		<tr>
			<th scope="row">사용자 검색옵션</th>
			<td class="td_extra">
				<input type="text" name="it_1_subj" id="it_1_subj" value="검색옵션" class="frm_input" readonly>
				<?if($it['it_1'] != ''){//사용자검색 체크박스값
					$i1 = explode("|",$it['it_1']);
				}?>
				<input type="checkbox" name="it_1[0]" value="남성선글라스"
					<?
					if($i1[0] == '남성선글라스'){
						echo "checked";
					}
				...
				<input type="checkbox" name="it_1[1]" value="여성선글라스" 
					<?
					if($i1[1] == '여성선글라스'){
						echo "checked";
					}
				...
				<input type="checkbox" name="it_1[2]" value="연예인착용"
					<?
					if($i1[2] == '연예인착용'){
						echo "checked";
					}
				...
				<input type="checkbox" name="it_1[3]" value="스포츠"
					<?
					if($i1[3] == '스포츠'){
						echo "checked";
					}
