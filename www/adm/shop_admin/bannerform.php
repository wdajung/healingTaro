    ...
    <tr>
        ...
        <td>
            ...
            <select name="bn_position" id="bn_position">
				...
				<option value="브랜드" <?php echo get_selected($bn['bn_position'], '브랜드'); ?>>브랜드</option>
				<option value="lookbook" <?php echo get_selected($bn['bn_position'], 'lookbook'); ?>>lookbook</option>
				<option value="new" <?php echo get_selected($bn['bn_position'], 'new'); ?>>new</option>
				<option value="sale" <?php echo get_selected($bn['bn_position'], 'sale'); ?>>sale</option>
				<option value="reviews" <?php echo get_selected($bn['bn_position'], 'reviews'); ?>>reviews</option>
				<option value="event" <?php echo get_selected($bn['bn_position'], 'event'); ?>>event</option>
				<option value="왼쪽고정" <?php echo get_selected($bn['bn_position'], '왼쪽고정'); ?>>왼쪽고정</option>
        </select>
        </td>
    </tr>
    <tr>
