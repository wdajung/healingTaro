...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
		...
		<td colspan="3">
	        <input type="text" name="mb_1" value="<?php echo $mb['mb_1'] ?>" id="mb_1" class="frm_input" size="30" maxlength="255">&nbsp;&nbsp;<b>예금주</b><br>
			<select name="mb_2" class="frm_input">
			<?if($mb['mb_2'] != ''){?>
					<option value="<?=$mb['mb_2']?>" selected><?=$mb['mb_2']?></option>
			...
			<input type="text" name="mb_3" value="<?php echo $mb['mb_3'] ?>" id="mb_3" class="frm_input" size="30" maxlength="255">&nbsp;&nbsp;<b>계좌번호</b>
			<div style="display:none;">
			<input type="text" name="mb_4" value="<?php echo $mb['mb_4'] ?>" id="mb_4" class="frm_input" size="30" maxlength="255">
			<input type="text" name="mb_5" value="<?php echo $mb['mb_5'] ?>" id="mb_5" class="frm_input" size="30" maxlength="255">
			<input type="text" name="mb_6" value="<?php echo $mb['mb_6'] ?>" id="mb_6" class="frm_input" size="30" maxlength="255">
			<input type="text" name="mb_7" value="<?php echo $mb['mb_7'] ?>" id="mb_7" class="frm_input" size="30" maxlength="255">
			<input type="text" name="mb_8" value="<?php echo $mb['mb_8'] ?>" id="mb_8" class="frm_input" size="30" maxlength="255">
			<input type="text" name="mb_9" value="<?php echo $mb['mb_9'] ?>" id="mb_9" class="frm_input" size="30" maxlength="255">
			<input type="text" name="mb_10" value="<?php echo $mb['mb_10'] ?>" id="mb_10" class="frm_input" size="30" maxlength="255">
			</div>
