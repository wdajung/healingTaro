...
<div class="tab_menu05 hidden-xs hidden-sm">
	<ul>
		<li class=""><a href="<?php echo G5_URL?>/sub1.php">생크림소개</a></li>
		<li class="on"><a href="<?php echo G5_URL?>/sub1_2.php">오시는길</a></li>
		<p class="clear"></p>
	</ul>
</div>
<!--					
...
<div style="padding-top:30px; padding-bottom:30px;">
	<div id="wrapper">		
		<div id="container">
			<p style="text-align:center; font-size:2.5em; padding:10px 0 20px 0;">오시는길</p>
			...
			<img src="<?php echo G5_URL?>/img/add_icon.png" width="40px"><span style="padding-left:10px; font-size:1.15em;">남양주시 다산순환로420 성산플레이스3 403호</span><br><br>
			<img src="<?php echo G5_URL?>/img/tel_icon.png" width="40px"><span style="padding-left:10px; font-size:1.15em;">031-814-8824</span>
			</div>
		</div>
	</div>
</div>
