...
<div id="ssch">
    ...
    <div id="ssch_frm">
		...
		<input type="hidden" name="w_it" value="<?php echo $w_it?>">
        <div>
            <strong>검색범위</strong>
    ...
    <div>
        ...
        echo get_paging($config['cf_mobile_pages'], $page, $total_page, $_SERVER['SCRIPT_NAME'].'?'.$query_string.'&amp;page=&w_it='.$w_it);
        ?>
    </div>
    <!-- } 검색결과 끝 -->
