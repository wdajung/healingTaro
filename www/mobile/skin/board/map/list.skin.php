...
<div id="bo_list" style="width:<?php echo $width; ?>; font-family: 'NanumSquareRound',sans-serif;">
    ...
    <div id="map_right_wrapper">
        ...
        <fieldset id="bo_sch">
            ...
            <select name="sfl" id="sfl" style="width:33%; height:50px; padding-left:10px;">
            ...
            <input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required  class="frm_input required" size="15" maxlength="15" style="width:55%; height:50px; font-size:1.5em; padding-left:10px;">
            <input type="submit" value="검색" class="btn_submit" style="width:92%; height:50px; background:#444; margin-top:5px;">
            </form>
        </fieldset>
        <!-- } 게시판 검색 끝 -->
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <?php } ?>
            <th scope="col" colspan="2" width="35%">해당지역</th>
            <th scope="col" width="25%">담당지역</th>
            <th scope="col" width="30%">연락처</th>
        </tr>
        </thead>
        <tbody>
        <?php
...
if($thumb['src']) {
    ...
    $img_content = '<span style="width:'.$board['bo_gallery_width'].'px;height:'.$board['bo_gallery_height'].'px">no image</span>';
         ...
         ?>
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>" style="font-size:1em;">
            <td class="td_num">
            <?php
