...
<section id="bo_w">
	...
	<div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
			<tr>
				<th>시도</th>
				<td colspan="3"><input type="text" name="wr_9" id="wr_9" value="<?php echo $wr_9 ?>"></td>
			</tr>
			<tr>
				<th>구군</th>
				<td colspan="3"><input type="text" name="wr_10" value="<?php echo $wr_10 ?>" id="wr_10" required class="frm_input required" size="20" maxlength="20" style="height:2.2em; font-size:1.2em; padding-left:10px;"></td>
			</tr>
			<tr>
				<th><label for="wr_name">이름<strong class="sound_only">필수</strong></label></th>
				<td colspan="3"><input type="text" name="wr_name" value="<?php echo $name ?>" id="wr_name" required class="frm_input required" size="20" maxlength="20" style="height:2.2em; font-size:1.2em; padding-left:10px;"></td>
			</tr>
			<tr>
				<th><label for="wr_subject">핸드폰<strong class="sound_only">필수</strong></label></th>
				<td colspan="3"><input type="text" name="wr_subject" value="<?php echo $name ?>" id="wr_subject" required class="frm_input required" size="20" maxlength="20" style="height:2.2em; font-size:1.2em; padding-left:10px;"></td>
			</tr>
			<tr>
				<th>연령(학년)</th>
				<td colspan="3"><input type="text" name="wr_8" id="wr_8" value="<?php echo $wr_8 ?>"></td>
			</tr>
			<tr>
				<th>희망상담방법</th>
	...
	<script src="/js/makebox.js"></script>
			...
			<script>
			$( '#wr_8' ).makeBox('학년선택,4세,5세,6세,7세,1학년,2학년,3학년,4학년,5학년,6학년,중1학년,중2학년,중3학년', 'select' );
			</script>
