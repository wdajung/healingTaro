...
?>
    ...
    <input type="hidden" name="fix_inst" value="02">

    <!--  무이자 옵션
            ※ 설정할부    (가맹점 관리자 페이지에 설정 된 무이자 설정을 따른다)                             - "" 로 설정
            ※ 일반할부    (KCP 이벤트 이외에 설정 된 모든 무이자 설정을 무시한다)                           - "N" 로 설정
            ※ 무이자 할부 (가맹점 관리자 페이지에 설정 된 무이자 이벤트 중 원하는 무이자 설정을 세팅한다)   - "Y" 로 설정 -->
    <input type="hidden" name="kcp_noint" value="Y"> 
    ...
    <!-- 사용카드 설정 파라미터 입니다. (해당 카드만 결제창에 보이게 설정하는 파라미터입니다. used_card_YN 값이 Y일때 적용됩니다. 국민CCKM 하나CCHN 농협CCBC  추가하기 -->
    <input type="hidden" name="used_card" value="CAMF:CCAM:CCCH:CCCJ:CCCT:CCDI:CCDN:CCHM:CCJB:CCKE:CCKJ:CCKW:CCLG:CCPH:CCSH:CCSS:CCSU:CDIF:CJCF:CMCF:CVSF:CCSG:CJCF">
