...
label {font-size:1.2em; margin-right:5px;}
</style>

<div id="wrapper">
    <div id="container" style="font-family: 'NanumSquareRound',sans-serif;">

<form name="forderform" id="forderform" method="post" action="<?php echo $order_action_url; ?>" autocomplete="off">
<div id="sod_frm" style="padding:30px 0;">
    <!-- 주문상품 확인 시작 { -->
    <p style="font-size:1.2em;">주문하실 상품을 확인하세요.</p>
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        for ($i=0; $row=sql_fetch_array($result); $i++)
        {
			...
			if($member[mb_level] == '3'){
				$sell_price = (int)($sum['price'] * 0.97);//3% prime 레벨3고객
			}else if($member[mb_level] == '4'){
				$sell_price = (int)($sum['price'] * 0.95);//5% passion 레벨4고객
			}else if($member[mb_level] == '5'){
				$sell_price = (int)($sum['price'] * 0.93);//7% vip 레벨5고객
			}else if($member[mb_level] == '6'){
				$sell_price = (int)($sum['price'] * 0.90);//10% vvip 레벨6고객
			}else{
    ...
    <section id="sod_frm_orderer">
        ...
        <div class="tbl_frm01 tbl_wrap">
            ...
            <tr>
                <th scope="row"><label for="od_tel">핸드폰<strong class="sound_only"> 필수</strong></label></th>
		    ...
		    <!-- tr>
                <th scope="row"><label for="od_hp">학생이름</label></th>
                <td><input type="text" name="od_hp" value="<?php echo get_text($member['mb_hp']); ?>" id="od_hp" required class="frm_input" maxlength="20"></td>
            </tr -->
            <!--
			<?php if ($is_admin) {?>
			 <tr>
    ...
    <section id="sod_frm_taker">
        ...
        <div class="tbl_frm01 tbl_wrap">
		   ...
		   <tr>
            ...
            <?php } ?>-->
            <tr>
                <th scope="row"><label for="od_b_name">선생님이름<strong class="sound_only"> 필수</strong></label></th>
                <td><input type="text" name="od_b_name" id="od_b_name" required class="frm_input required" maxlength="20"></td>
            </tr>
            <tr>
                <th scope="row"><label for="od_b_tel">코드번호<strong class="sound_only"> 필수</strong></label></th>
    ...
    <section id="sod_frm_pay">
        ...
        if (!$default['de_card_point'])
           // echo '<p id="sod_frm_pt_alert"><strong>무통장입금</strong> 이외의 결제 수단으로 결제하시는 경우 포인트를 적립해드리지 않습니다.<br>[무통장입금시  5일이내 미입금일경우 주문이취소됩니다.]</p>';
