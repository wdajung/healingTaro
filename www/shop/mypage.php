    ...
    <section id="smb_my_ov">
        ...
        <div id="smb_my_act">
            <ul>
                ...
                <li><a href="<?php echo G5_BBS_URL; ?>/member_confirm.php?url=register_form.php" class="btn01">회원
				정보수정</a></li>
				<!--<li><a href="<?php echo G5_SHOP_URL; ?>/couponzone.php" class="btn02">쿠폰</a></li>-->
        ...
        <dl>
            ...
            <dt>보유쿠폰</dt>
            <dd>
				<a href="<?php echo G5_SHOP_URL; ?>/coupon.php" target="_blank" class="win_coupon" style="border:1px solid red; padding-left:3px; padding-right:3px;">
					<!--<?php echo number_format($cp_count); ?>-->
