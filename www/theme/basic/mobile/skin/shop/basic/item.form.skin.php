            ...
            <ul id="sit_opt_added">
                <li class="sit_opt_list">
                    ...
                    <div class="sit_opt_qty">
                        ...
                        <button type="button" class="sit_qty_plus">+</button>
                        <button type="button" class="sit_qty_minus">-</button>
                    </div>
                </li>
            </ul>
            <script>
...
<aside id="sit_siblings">
    ...
    <!--<ul id="sit_more">
        <li>
			<a href="<?php echo $href; ?>" target="_blank">상품설명</a>
		</li>
        
		<?php if ($default['de_baesong_content']) { ?><li><a href="<?php echo $href; ?>&amp;info=dvr" target="_blank">정보</a></li><?php } ?>
        <li>
			<a href="<?php echo $href; ?>&amp;info=use" target="_blank">
				후기<span class="item_use_count"><?php echo $item_use_count; ?></span></a></li>
        <li><a href="<?php echo $href; ?>&amp;info=qa" target="_blank">상품문의<span class="item_qa_count"><?php echo $item_qa_count; ?></span></a></li>
    </ul>-->
	<table style="border:1px solid #e9e9e9; border-collapse:collapse; position:fixed; bottom:0px; background:#FFF;" width="100%" >
		<tr>
			<th style="border:1px solid #e9e9e9; padding:10px 5px;" width="25%">
				<a href="<?php echo $href; ?>" target="_blank">상품설명</a>
			</th>
			<?php if ($default['de_baesong_content']) { ?>
			<th style="border:1px solid #e9e9e9; padding:10px 5px;" width="25%">
				<a href="<?php echo $href; ?>&amp;info=dvr" target="_blank">정보</a>
			</th>
			<?}?>
			<th style="border:1px solid #e9e9e9; padding:10px 5px;" width="25%">
				<a href="<?php echo $href; ?>&amp;info=use" target="_blank">
					후기<span class="item_use_count"><?php echo $item_use_count; ?></span>
				</a>
			</th>
			<th style="border:1px solid #e9e9e9; padding:10px 5px;" width="25%">
				<a href="<?php echo $href; ?>&amp;info=qa" target="_blank">
					상품문의<span class="item_qa_count"><?php echo $item_qa_count; ?></span>
				</a>
			</th>
		</tr>
	</table>
