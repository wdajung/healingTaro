...
<div id="bo_gall">
    ...
    <ul id="gall_ul" style="list-style:none; padding:0px; -webkit-padding-start:0px;">
        <?php
        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>">
            ...
            <div class="gall_txt">
                ...
                <?php } ?>
                <a href="<?php echo $list[$i]['href'] ?>" class="gall_tit">
                    <?php echo cut_str($list[$i]['subject'],10)?>
					<?php if ($list[$i]['comment_cnt']) { ?><span class="sound_only">댓글</span>(<?php echo $list[$i]['comment_cnt']; ?>)<span class="sound_only">개</span><?php } ?>
                </a>

                <p class="gall_detail"><?php echo $file[0]['content']; ?></p>
                <div class="gall_if">
                <span class="sound_only">작성일 </span><?php echo $list[$i]['datetime'] ?><span class="sound_only">작성자 </span> by.<?php echo $list[$i]['name'] ?></div>
            </div>
        </li>
        <?php } ?>
