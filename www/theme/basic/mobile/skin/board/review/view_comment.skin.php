...
<section id="bo_vc">
    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        <header>
            <h3><?php echo get_text($list[$i]['wr_name']); ?>님의 댓글</h3>
        ...
        <div class="tbl_frm01 tbl_wrap">
            ...
            <tr>
                ...
                <td>
                    ...
                    <label for="wr_secret"><i class="fa fa-lock" aria-hidden="true"></i> 비밀글사용</label><input type="checkbox" name="wr_secret" value="secret" id="wr_secret">
            </tr>
            </tbody>
            </table>
        </div>
