...
<div class="tab_menu05 hidden-xs hidden-sm">
	<ul>
		<li class="on"><a href="<?php echo G5_THEME_SHOP_URL?>/sub1.php">생크림소개</a></li>
		<li class=""><a href="<?php echo G5_THEME_SHOP_URL?>/sub1_2.php">오시는길</a></li>
		<p class="clear"></p>
	</ul>
</div>
<!--					
...
<div style="padding-top:30px; padding-bottom:30px;">
	<div id="wrapper">		
		<div id="container">
			<img src="<?php echo G5_URL?>/img/sub1_1.png" class="img-responsive">
			<img src="<?php echo G5_URL?>/img/sub1_2.png" class="img-responsive">
		</div>
	</div>
</div>
</section>
