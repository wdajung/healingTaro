...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <?php
    if($view['wr_1']) {
        $sql = " select * from {$g5['g5_shop_item_table']} where it_id in ( '".str_replace(',', "', '", $view['wr_1'])."' ) order by it_order, it_id desc ";
    ...
    <div id="bo_v_prd">
        ...
        <ul style="list-style:none;">
            ...
            ?>
            <li>
                <a href="<?php echo $href; ?>" class="prd_img"><?php echo $img; ?></a>
                <a href="<?php echo $href; ?>" class="prd_name"><?php echo $name; ?></a>
                <span class="prd_cost"><?php echo display_price(get_price($row)); ?></span>
            </li>
            <?php
            }
            ?>
