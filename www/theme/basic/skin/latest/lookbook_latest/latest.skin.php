...
<section class="n_gallery_wrap">
  ...
  <ul class="n_thumb">
    ...
    <li style="background:#fff; margin-bottom:22px; margin-left:22px;">
      ...
      <p style="text-align:center;">
			<a href="<?php echo $list[$i]['wr_link1'] ?>" style="font-family:'Nanum Gothic';"><font size="1.6em"><?php echo $list[$i]['ca_name'] ?></font></a><br>
			<a href="<?php echo $list[$i]['wr_link1']; ?>" style="font-family:'Nanum Gothic'"><font size="2em" color="#999"><?php echo $list[$i]['subject']; ?></font></a>
		</p>
    </li>
    <?php } ?>
  </ul>
