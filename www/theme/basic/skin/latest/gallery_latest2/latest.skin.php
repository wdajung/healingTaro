  ...
  <ul class="n_thumb">
    ...
    <li style="background:#fff">
      ...
      <p style="text-align:center;">
			 <a href="<?php echo $list[$i]['wr_link1'] ?>"><font size="3em"><b><?php echo $list[$i]['ca_name'] ?></b></font></a><br>
			<a href="<?php echo $list[$i]['wr_link1']; ?>"><font size="2em" color="#999"><b><?php echo $list[$i]['subject']; ?></font></b></a>
		</p>
    </li>
    <?php } ?>
  </ul>
