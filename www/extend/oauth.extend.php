...
// 네이버로그인 API 정보
define('G5_NAVER_OAUTH_CLIENT_ID',  '1CwsB47DvaDtWEuAn8TO');
define('G5_NAVER_OAUTH_SECRET_KEY', 'Rdlqy8x8k5');

// 카카오로그인 API 정보
define('G5_KAKAO_OAUTH_REST_API_KEY', '');

// 페이스북로그인 API 정보
define('G5_FACEBOOK_CLIENT_ID',  '1408882935798894');
define('G5_FACEBOOK_SECRET_KEY', '2d3ccb74581815f1b5078ac2b8d2bff1');
